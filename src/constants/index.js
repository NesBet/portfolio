...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Tracking utility consumption, emissions and waste diversion rates, producing reports for management and ESG disclosures.",
      "Establishing waste management, water conservation and responsible sourcing practices aligned to NCBA's ESG strategy.",
      "Implementing sustainable practices and reducing carbon footprint through energy efficiency and waste reduction initiatives.",
      "Maintaining a vetted supplier database, negotiating contract terms and conducting periodic evaluations to mitigate supply chain risk.",
      "Implementing scheduled maintenance for MEP and civil assets across the branch network to minimise downtime and extend asset life.",
      "Overseeing contracted service providers for cleaning, security and maintenance, enforcing SLA compliance through regular reviews.",
      "Managing branch infrastructure and refurbishment projects from initiation through commissioning — on time and within budget.",
    ],
  },
];
